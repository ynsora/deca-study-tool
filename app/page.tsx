...
const features = [
  ...
  },
  {
    ...
    description: "Event-specific DECA scenarios with planning timer, judge questions, and detailed scored feedback.",
    cta: "Start Roleplay",
    bg: "#001a0f",
    border: "#1a5c36",
    accent: "#4ade80",
    ...
    <div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <p className="max-w-lg text-sm mb-6" style={{ color: "#666" }}>
          ...
          and full PI + 21st Century Skills scoring with an animated breakdown.
        </p>
